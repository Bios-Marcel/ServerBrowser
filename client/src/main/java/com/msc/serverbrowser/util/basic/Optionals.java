...
public class Optionals {
	 ...
	 * the retrieved {@link Object} equals <code>null</code>, {@link Optional#empty()} will be returned.
	 *
	 * @param supplier
	 *            {@link Supplier} that supplies the returned (wrapped) object
	 * @return An {@link Optional} of the {@link Object} returned by the {@link Supplier} or {@link Optional#empty()}
	 */
